          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2">
              <input
                ...
                className="h-11 rounded-lg border border-neutral-200 bg-white px-4 text-xs outline-none transition focus:border-[#22c51f] focus:ring-1 focus:ring-green-100"
              />
              <button
                type="button"
