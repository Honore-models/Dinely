...
export const AmexIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 60" {...props}>
    <rect width="100" height="60" rx="6" fill="#016fd0"/>
    <path fill="#fff" d="M22.5 39l-4.1-10.2H14l-4 10.2H6l9.6-22h5.8l9.4 22h-8.3zm-8.3-13.6l-2 4.9h4l-2-4.9zM38.8 39V17h8l5 12 5-12h8v22h-5.2V23.7l-5.7 13.6h-4.3l-5.6-13.6V39h-5.2zM75.8 39v-4.8H86V29.3H75.8v-4.5H87V17H70.6v22h16.8V39H75.8z" />
  </svg>
);
...
export const RwandaFlagIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 24" {...props}>
    <rect width="36" height="24" fill="#20603D"/>
    <rect width="36" height="18" fill="#FAD201"/>
    <rect width="36" height="12" fill="#00A1DE"/>
    <path fill="#FAD201" d="M 28 8 l 0.5 -2.5 l 1.5 2 l -2.5 0.5 z"/> 
