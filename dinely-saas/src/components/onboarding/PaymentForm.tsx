      ...
      <div className="mt-4 grid gap-6 lg:grid-cols-[1fr_315px]">
        <form className="max-w-lg" onSubmit={(e) => e.preventDefault()}>
          <h2 className="mb-3 flex items-center gap-3 text-xl font-bold text-neutral-500">
            <CreditCard className="fill-[#22c51f] text-[#22c51f]" /> Payment
            Details
          </h2>
          <div className="space-y-3">
            ...
            <label className="block">
              <span className="mb-1 block text-base font-semibold text-black">
                Card Details
              </span>
            ...
            <div className="flex items-center gap-4 rounded-lg border border-green-100 bg-green-50 p-3">
              ...
              <p className="font-semibold text-neutral-600">
                ...
                <span className="block">
                  You will only be charged after Confirmation
                </span>
              </p>
            </div>
            <Button
            ...
            <p className="flex items-start gap-2 text-sm font-semibold text-neutral-600">
              <ShieldCheck className="shrink-0 text-[#22c51f]" size={22} /> By
          ...
          <div className="mt-4 border-t border-neutral-200 pt-3">
            ...
            <ul className="mt-3 space-y-3">
              {planFeatures[selectedPlan].map((feature) => (
                ...
                >
                  <CheckCircle2 className="text-[#22c51f]" size={19} />{" "}
                  {feature}
                </li>
              ))}
            </ul>
